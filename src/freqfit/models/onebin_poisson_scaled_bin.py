...
def nb_extendedrvs(
    ...
    n_sig = np.random.poisson(S + deltaE * B)
...
class onebin_poisson_scaled_bin_gen(Model):
    def __init__(self):
    ...
    def logpdf(
        ...
        return np.log(nb_pdf(Es, S, B, deltaE))
    ...
    def density(
        ...
        return nb_density(Es, S, B, deltaE)
    ...
    def logdensity(
        ...
        return np.log(nb_density(Es, S, B, deltaE))
    ...
    def extendedrvs(
        ...
        return nb_extendedrvs(S, B, deltaE)
...
onebin_poisson_scaled_bin = onebin_poisson_scaled_bin_gen()
