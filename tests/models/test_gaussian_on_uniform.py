...
def test_gaussian_on_uniform_pdf():
    ...
    model_values = gaussian_on_uniform.pdf(Es, S, BI, delta, sigma, eff, exp, WINDOW)
...
def test_gaussian_on_uniform_logpdf():
    ...
    # compute using our function
    model_values = gaussian_on_uniform.logpdf(
        Es, S, BI, delta, sigma, eff, exp, window=window
    )
