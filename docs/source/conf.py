...
html_theme = "furo"
html_theme_options = {
    "source_repository": "https://github.com/cenpa/legendfreqfit",
    "source_branch": "main",
...
Jupyter_ notebook available in the `legendfreqfit repository
<https://github.com/cenpa/legendfreqfit/tree/main/docs/source/notebooks>`_.
